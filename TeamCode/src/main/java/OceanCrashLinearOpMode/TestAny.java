...
public class TestAny extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startingPose)
                .addTemporalMarker(.25, () -> targetPos = 1500)
                ...
                .lineToLinearHeading(new Pose2d(-20.8, 35.091, Math.toRadians(-45)))
                .build();

        TrajectorySequence turn135 = drive.trajectorySequenceBuilder(traj1.end())
                .addDisplacementMarker(()-> targetPos = 700)
                .turn(Math.toRadians(135))
                .build();

        Trajectory traj2 = drive.trajectoryBuilder(turn135.end())
                //.lineToLinearHeading(new Pose2d(-29.5, 34.5, Math.toRadians(90)))
                .lineToLinearHeading(new Pose2d(-22.35, 54, Math.toRadians(90)), SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL, Math.toRadians(80), DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
