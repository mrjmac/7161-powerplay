package OceanCrashPurePursuit.autonomous;
...
import OceanCrashPurePursuit.autonomous.waypoints.Subroutines;
import OceanCrashPurePursuit.autonomous.waypoints.Waypoint;
import OceanCrashPurePursuit.common.math.Line;
...
public class PurePursuitPath {
    ...
    public static double DEAD_MAN_SWITCH = 1500;
    ...
    public PurePursuitPath(CombinedRobot robot) {
        this(robot, new LinkedList<>());
    }

    public PurePursuitPath(CombinedRobot robot, Waypoint... points) {
        this(robot, Arrays.asList(points));
    }

    public PurePursuitPath(CombinedRobot robot, List<Waypoint> waypoints) {
